...
public class LyraAdaptiveWeb extends AndroidNonvisibleComponent {
    ...
    @SimpleFunction(description = "Cria o WebViewer customizado dentro de um arranjo (ex: VerticalArrangement).")
    ...
    @SimpleFunction(description = "Ativa a adaptação avançada do teclado para evitar que cubra o WebViewer ou campos de texto.")
    ...
    @SimpleEvent(description = "Disparado quando o JavaScript retorna um valor.")
